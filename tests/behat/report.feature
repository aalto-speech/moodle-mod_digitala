...
Feature: Student can see report with transcript, numeric gradings and verbal feedback
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | digitala | Test digitala name | Test digitala intro  | C1     | digitala1 | fi          | freeform    | Assignment text            | Resource text                              | 1               | 0            | testinformation |  1                 |
      | digitala | Freeform           | This is a freeform.  | C1     | freeform  | sv          | freeform    | Berätta om Tigerjakt.      | Här är filmen om tiger.                    | 1               | 0            | new information |  1                 |
      | digitala | Readaloud          | This is a readaloud. | C1     | readaloud | fi          | readaloud   | Lue seuraava lause ääneen. | Tämä on liikennevalojen perusteet -kurssi. | 1               | 2            | ööh infoa       |  1                 |
  ...
  Scenario: On a non graded report page the report not available text is shown
    When I am on the "Test digitala name" "mod_digitala > Report" page logged in as "olli"
    Then I should see "The evaluation report for this assignment is not available yet."
  ...
  Scenario: Detailed report shows correctly for freeform
    ...
    And I should see "This measure is based on the previous responses that have been used in teaching the machine to grade this task."
    And I should see "1/3"
    And I should see "Based on the automatic grading, it seems that you only partially responded to the assignment."
    ...
    And I should see "Based on the automatic grading, it seems that your speech has many pauses, breaks, or hesitations."
    ...
    And I should see "Based on the automatic grading, it seems that"
    ...
    And I should see "This measure reflects how much you have spoken and how comprehensive your vocabulary and sentence structures are."
    And I should see "3/3"
    And I should see "Based on the automatic grading, it seems that you have comprehensive vocabulary and use a variety of sentence structures."
  ...
  Scenario: Detailed report shows correctly for freeform if failed to evaluate
    ...
    And I should see "Based on the automatic grading, it seems that"
    And I should see "unfortunately, the machine has not heard this type of performance before and therefore failed to grade your speech."
    And I should see "Fluency"
    And I should see "This measure reflects the speed, pauses, and hesitations in your speech."
  ...
  Scenario: Detailed report shows correctly for readaloud if failed to evaluate
    ...
    And I should see "This measure reflects the speed, pauses, and hesitations in your speech."
    And I should see "0/4"
    And I should see "Based on the automatic grading, it seems that unfortunately, the machine has not heard this type of performance before and therefore failed to grade your speech."
    And I should see "Pronunciation"
    And I should see "Above you can see that the machine transformed your speech into text. There you can check whether you pronounced all the words right. This measure reflects how well the machine understands your speech. The speech samples that the machine has heard before affect its ability to understand you."
    And I should see "0/4"
    And I should see "Based on the automatic grading, it seems that"
