...
$string['assignmentresource_help'] = 'Aineisto, esimerkiksi ääneen luettava teksti, voidaan liittää tähän. Vapaa tuotto -tehtävässä tähän voidaan lisätä tekstiä, kuvia, kaavioita ja videoita, joita tulee hyödyntää.';
