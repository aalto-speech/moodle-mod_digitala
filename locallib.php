...
function save_attempt($assignment, $filename, $evaluation, $recordinglength) {
    ...
    if ($assignment->attempttype == 'freeform') {
        $attempt->taskcompletion = $attempt->taskcompletion > 3 ? 0 : $evaluation->task_completion;
        ...
        $attempt->fluency = $attempt->fluency > 4 ? 0 : $evaluation->fluency->score;
        ...
        $attempt->pronunciation = $attempt->pronunciation > 4 ? 0 : $evaluation->pronunciation->score;
        ...
        $attempt->lexicogrammatical = $attempt->lexicogrammatical > 3 ? 0 : $evaluation->lexicogrammatical->score;
        ...
        $attempt->holistic = $attempt->holistic > 6 ? 0 : $evaluation->holistic;
        ...
        $attempt->gop_score = $attempt->gop_score < 1 ? 0 : $evaluation->GOP_score;
