...
class mod_digitala_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('textarea', 'assignment', get_string("digitalaassignment", "mod_digitala"), array('rows' => 10, 'cols' => '64'));
        ...
        $textfieldoptions = array('trusttext' => false, 'subdirs' => true, 'maxfiles' => -1, 'maxbytes' => $CFG->maxbytes, 'context' => $this->context, 'changeformat' => true, 'noclean' => true);
        $mform->addElement('editor', 'resources', get_string("digitalaassignmentresource", "mod_digitala"), array('rows' => 10), $textfieldoptions);
